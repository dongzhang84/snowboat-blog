...
六年下来，我的结论是：市面上大多数"AI 学习路线图"有一个通病。它们不问你要做什么，上来就让你啃线代、啃概率、啃 CNN、啃 RNN、啃 Transformer、啃 BERT、啃 GPT。等你啃到一半精疲力尽，发现还没写过一行能跑的代码。

这六年我见过太多物理、数学、计算机背景的朋友，拿着一份看起来很全的路线图，最后卡在第二阶段没出来。

所以今天这份不是完整路线图。是两个必须先回答的问题，和三个方向的分叉。
