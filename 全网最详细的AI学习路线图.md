...
简单介绍一下我自己。我本科物理专业，一直是年级第一；博士读的是天体物理，一度以为这辈子就做物理学家了。后来判断整个物理学科走进了死胡同，果断转 AI，做到美国大厂的算法工程师。我的 AI 全是自学，从最基础的线性回归到 CNN、Transformer，再到现在每天在调的 LLM Agent。没有 CS 背景、没有人带，全是在 production 里边摸边学，走了六年。
