...
你打开一个AI助手，跟它说：帮我把下周三下午跟张总的会挪到周四，再顺手发封邮件通知他。

放到今天，一个像样的助手不会糊弄你。它要么真连着你的日历和邮箱，把事办了，要么老老实实告诉你：我看不到你的日历，也没法替你发邮件。后面这句大实话，才是过去两年AI真正卡住的地方。

模型本身已经很强了。它能写代码、能推理、能跟你聊哲学，甚至能联网查到今天的新闻和此刻的航班价格。可它的本事全都隔着一层。它知道全世界的菜谱，却打不开你家的冰箱。它能搜遍公开的互联网，却进不去你公司的数据库、你正在写的那份文档、你们内部那套审批系统。

打个比方，这就像你雇了个智商极高的秘书，履历漂亮、反应飞快，却被锁在一间隔音玻璃房里。你能隔着玻璃跟他说话，他也能看报纸、看电视，对外面的世界门儿清。可你桌上的任何一份文件他都拿不到，你的电话他碰不着，你的门他也开不了。在"陪你聊天"的年代，这没问题。到了"替你办事"的年代，这层玻璃就成了最大的障碍。

更麻烦的是，就算你想把玻璃凿开，让它连上一个工具，也不轻松。连日历是一套接法，连邮箱是另一套，连公司数据库又是第三套，每多接一个，工程师就得重写一遍。模型这边有几十种，工具那边成千上万，两两去对接，是个能把人累垮的活。

这篇文章讲的，就是工程师们怎么用一套统一的办法，给这个被关起来的大脑装上眼睛和手。这套方案有个名字，叫MCP，全称Model Context Protocol，模型上下文协议。注意是MCP，不是MPC，后者是另一回事。它2024年底才出现，一年多就铺遍了整个行业，连最大的竞争对手都主动用上了它。

它要解决的，是一个在计算机历史上反复出现、每次都很难、每次解决之后都会引爆一波增长的老问题。我们慢慢说。
...
这就是引子里那个隔音玻璃房：秘书能隔着玻璃看报、看电视，对外面的世界门儿清，可你桌上的文件他一份也拿不到。聊天的年代这不碍事，办事的年代，这道玻璃就是最大的障碍。
...
再补一个现实里绕不开的环节：出错怎么办。真实世界里数据库可能连不上，权限可能不够，模型也可能挑错工具。MCP的流程允许服务端把"这次没成功、原因是什么"原样回报给模型，模型据此换个工具重试，或者老实告诉你"这件事我没做成，因为没权限"。引子里那个被锁在玻璃房里的助手，只能隔着玻璃告诉你它够不到你的日历。装上手脚之后真正的区别在于，它不光够得着了，碰上权限不够、系统连不上这类岔子，还能把卡在哪儿如实说给你听。
