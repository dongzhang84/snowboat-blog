...
但要诚实承认这种解释有事后诸葛亮的味道。"成功的找匹配、失败的找不匹配"在论证形式上几乎不可证伪——给任何结果都能编出一个"是否匹配"的故事。这套解释帮助理解既有案例，但**对未来的预测力很弱**。物理学家四十年前不会预料到Hopfield网络在2020年突然被发现跟Transformer attention数学等价复活。
