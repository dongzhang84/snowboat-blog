...
创始人Tanguy Chau（CEO）和Michael Ulin（CTO）十年前在麦肯锡共事认识。Chau在MIT拿了硕士、博士、MBA，之前在硅谷做了约七年VC（Formation 8、Mayfield），2015年主导过Ironclad的早期投资，也参与过Casetext。

但这条VC人脉没给Paxton带钱也没带客户。Formation 8和Mayfield的老同事都不在Paxton的cap table上，Ironclad和Casetext被投公司的人也没有公开记录给Paxton介绍过客户或人才。真正沉淀下来的是PLG的pattern recognition，从产品上线第一天就做self-serve、公开定价、free trial。

2023年Chau进了Unusual Ventures的Unusual Academy。这是个一周强度的小cohort bootcamp，远到不了YC那档，更接近a16z START或Sequoia Arc那种"VC自家founder营"，本质是pre-series-A尽调通道。

Academy里真正起作用的是Vrionis追问的一个问题："你的产品到底解决了哪类客户死活离不开的事？"Paxton因此把市场从银行换到solo和小型律所。15个月后2025年1月Unusual自己领了2200万美元Series A，Academy实质就是自家A轮的pre-funnel。Seed是2023年9月600万美元，累计约2800万美元。
...
**对应的方法论**：圈外人加MIT工程背景，加七年VC沉淀下来的PLG打法（这条比"VC人脉"实际得多），加Unusual Academy这种小cohort项目作为A轮pre-funnel。客户起量主要靠founder-led outbound加earned media。在这名单里Paxton是PLG做得最早最干净的圈外人案例。
...
Theo AI 2024年成立，做诉讼结果预测和和解价值排序，目标客户是律所、诉讼基金、保险公司。

CEO Patrick Ip在UCLA法学院读JD时构思这家公司，之前在Google参与过被提名诺贝尔和平奖的项目、在联合国工作过，自己创过3家公司。CTO Tiago Luchini是5x founder，20年fintech / retail / biotech经验。联创Alex Alben在法律和operating两边都有几十年履历。

项目在Stanford StartX和UChicago ANVC孵化，跟Harvard、Caltech有研究合作。融资节奏特别快：2024年11月pre-seed 220万美元（NextView Ventures领投），2025年5月seed 420万美元（NextView加Collide Capital联合领投），2025年11月又拿340万美元（Run Ventures领投），累计超1000万美元。

第一批客户怎么签的公开资料没披露具体细节。能拼出来的是2025年11月跟最后那笔融资一起宣布了顾问委员会成立，靠学术孵化器加顾问背书换律所、诉讼基金、保险公司的早期信任。

**对应的方法论**：圈外技术人加自带JD学位加顶级孵化器组合拳加research partnership撑信用。这条路比PLG慢，但融资节奏特别顺。

## 1.7 GitLaw：给创业公司的自助合同工具

GitLaw 2025年成立，总部在SF，团队分布美英两地，做给startup和SME自助的AI合同工具。

创始人Nick Holzherr是英国连续创业者，上过英国版《学徒》（Apprentice）决赛，做过的食品类startup Whisk被三星收购。这次创业的核心信用就是上一次exit的连续创业者标签。

融资是2025年11月pre-seed 300万美元，Jackson Square Ventures领投，Flex Capital、Background Capital和一批天使跟投。

第一批客户走纯免费PLG。产品是1000多个律师审核过的模板库加AI agent帮起草、修订、谈判合同，主要客群是英美的startup和SME，律所反而不是客户。

**对应的方法论**：圈外人（连续创业者背景）加上一次创业被三星收购的信用加免费模板库做SME自助分发。这条路跟1.2 Spellbook是同一类，差别在Spellbook卖给律师，GitLaw卖给企业。

## 1.8 AttiFin AI：英国本地化路线

AttiFin AI 2025年成立，伦敦起步，已宣布搬到Newcastle，做英国法和地方法专用的enterprise AI，目标是英国政府和大律所。

创始人兼CEO是Shilpa Kaluti，公司背靠Scrumconnect的几位创始人。Scrumconnect是英国一家做政府数字化项目的公司，跟英国法院系统（HM Courts & Tribunals Service）和司法部（Ministry of Justice）合作过国家级项目Common Platform。

融资是2025年12月10日宣布的seed 500万英镑（约670万美元）。

2026年早些时候才正式上线，但Scrumconnect已有的政府客户关系是天然渠道。产品定位明确是"专门训练在英国法和地方法上、跑在英国数据中心里的enterprise AI"，本地化AI主权（UK数据中心加UK法系训练）是跟美国大玩家正面避战的差异化叙事。

**对应的方法论**：圈内人（政府客户关系）加enterprise路径加本地化数据主权叙事。这是欧洲 / 英国市场上典型的"data residency + regulatory moat"打法。

## 1.9 Soxton AI：Harvard + Cooley 的 startup-facing 法律服务

Soxton AI 2025年6月成立，是AI-native律所形态，目标客群是早期startup。

创始人Logan Brown，30岁，Harvard JD加前Cooley LLP律师加连续创业者。这套履历跟1.3 Crosby的Ryan Daniels几乎是镜像。

融资是2025年12月2日emerge from stealth时宣布的pre-seed 250万美元，Moxxie Ventures领投，Strobe、Coalition、Caterina Fake、Flex跟投。

公开launch之前的6个月已经服务270多家企业（incorporation、股权、融资、合规），客户首月平均省下4.5万美元法律费用，主要靠founder-led跑通。跟Crosby一样是AI-native律所形态。Crosby做的是Cursor这种已经做大的客户，Soxton服务的是早期startup。

**对应的方法论**：Harvard加Cooley加律师身份这套履历是顶级ticket。Soxton选的客群比Crosby更下沉，靠AI把Cooley起步律师那种基础事务全自动化，单客户金额低但量大。

## 1.10 Jurisage Group：加拿大同行合并打美国市场

Jurisage Group 2023年9月由Toronto的CiteRight跟Ottawa的Jurisage AI合并而成。CiteRight早就有产品在加拿大律所跑，Jurisage是Edmonton应用AI公司AltaML跟Ottawa的Compass Law合资孵化出来的。

合并后CEO是CiteRight的Aaron Wenner，Chief Innovation Officer是Jurisage的Colin Lachance（律师转技术创业者），CTO是Jurisage的Juliano Rabelo（几十年AI / ML经验）。背后是AltaML这个venture studio，模式跟2.3 Cascala Health那条Redesign Health路径是同一类。

融资是合并节点的125万美元（AltaML Fund加战略伙伴），CiteRight此前累计angel也超100万美元。

CiteRight那部分本来就有加拿大律所付费在用，合并主要是把Jurisage的AI能力套到CiteRight的客户基础上，并准备进美国市场。

**对应的方法论**：小市场（加拿大）里的同行先做横向整合再南下打美国，比孤军战要省力。这是地理边缘市场的venture studio路径：先在本地拿到产品和客户，再用合并加战略融资规模化。
