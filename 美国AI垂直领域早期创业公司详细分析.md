...
**那3年通用文档API时期靠什么活**：靠Lightspeed的种子轮支持。Jay的老东家直接投了Butler Labs的第一轮，这是他作为前Lightspeed合伙人的人脉变现。Butler Labs期间产品有真实付费客户（document extraction API卖给开发者），收入小但能跑团队。2023年决定pivot法律之前，公司有过一笔约1400万美元的扩展融资。所以"3年没找到PMF"不等于"3年没钱"。他全程是有VC钱在跑的。这点很关键：纯素人没钱、没产品、没工资就只能停下，Jay有Lightspeed的钱顶着才有pivot的资本。

转型法律之后融资节奏加速：a16z做Series A 4700万美元（2025年1月），理由是Eve当时年增长率800%。Spark Capital做Series B 1.03亿（2025年9月），理由是不到两年服务了450多家律所，每年处理20万 + 法律案件，帮律所回收和解金和判决金合计35亿美元。
