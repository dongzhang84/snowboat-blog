...
## 1.4 Paxton：圈外人 + MIT + PLG 打法

Paxton 2023年成立，俄勒冈州Bend。最初做的是给大银行的监管合规方案，后来转型法律。

创始人Tanguy Chau（CEO）和Michael Ulin（CTO），两人都是AI工程师，十年前在麦肯锡共事认识。Chau在MIT拿了硕士、博士、MBA，之前在硅谷做了约七年VC，先在Formation 8做Principal，后到Mayfield，2015年在Formation 8主导了Ironclad的早期投资，也参与过Casetext。做Paxton之前他还有一段不那么醒目的经历是某SEC/FINRA注册投顾公司的Chief Compliance Officer，这是公司一开始做银行合规AI的真正起点。

2023年Chau进了Unusual Ventures的Unusual Academy。这是个一周强度的小cohort bootcamp，由Unusual创始人John Vrionis和AppDynamics创始人Jyoti Bansal主持，给100万美元上限的uncapped SAFE加3%项目费。它远到不了YC那一档，更接近a16z START或Sequoia Arc那种"VC自家小规模founder营"，本质是个pre-series-A尽调通道。

Academy里真正起作用的是Vrionis追问的一个问题："你的产品到底解决了哪类客户死活离不开的事？"Paxton因此把市场从银行换到solo和小型律所。15个月后2025年1月Unusual自己领了2200万美元Series A，Academy实质就是个自家A轮pre-funnel。Seed早一些，2023年9月600万美元，累计融资约2800万美元。

那七年VC经历实质帮了多少要诚实拆。Formation 8和Mayfield的老同事公开记录里都不在Paxton的cap table上，Ironclad和Casetext那批早期被投公司的人也没有公开记录给Paxton介绍过客户、产品反馈或人才。真正帮上忙的是PLG pattern recognition，他从产品上线第一天就做self-serve、公开定价、free trial，这套打法在传统法律科技里不常见。融资语言流利也有用，从0到Series A只用了16个月。还有一项是Unusual Academy这种小cohort项目本身就是VC圈才进得去。VC背景给了playbook和access，没给钱也没给客户。

早期客户是founder-led outbound跑通的。按Unusual的case study说法，团队"对着几百个潜在客户做了outbound"，channel组合是LinkedIn campaign加跑律师协会（bar association）加给solo和单合伙人律所先免费用收反馈。Stanford法律幻觉benchmark 94%这个数字也帮了忙，2024年7月Artificial Lawyer和LawSites报道之后inbound起量。要注意这个94%是Paxton自己在Stanford原始约75万task里挑了1600个subset做自测出来的，不是Stanford自己评的分数，对外引用时需要带注脚。Chau本人的分发偏LinkedIn加earned media，不走Twitter那条线。

截至2025年底Paxton平台上有1500家以上律所（ABA Journal Legal Rebels数字），Series A前的9个月里MRR做了14倍、活跃客户8倍。当前定价Pro $199/月、Premium $299/月，企业版另谈。产品本体是法律研究与起草，主打可溯源（每句话能链接回原始法条），面向solo和小型律所。

**对应方法论**：圈外人加MIT工程背景，加SEC合规岗带来的领域钩子，加七年VC沉淀下来的PLG打法和Unusual Academy入场券。真正起量靠PLG（self-serve、公开定价、free trial）配合founder-led outbound（LinkedIn加律师协会）和Stanford benchmark这种earned media放大。Paxton和Spellbook都走PLG，但Spellbook靠Word插件自然渗透到大所，Paxton靠公开定价加earned media做放大。
