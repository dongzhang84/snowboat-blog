...
第一刀是科学verifier库，也就是3.3讲的那个判定器。它踩在训练Agent这个最烧钱的地方，而科学领域的可靠判定器又奇缺，做出来是所有训练科学Agent的人都要买的设施。第二刀是最优实验设计中间件，自驾实验室的大脑，资本密集、竞争又少，横切所有要决定下一步的科学Agent。第三刀是假科学检测器，最贴下一章要讲的那个科学界急着要盾牌的当下痛点，故事也最好讲。
