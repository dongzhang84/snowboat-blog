...
往上一层是认知科学。这一层有三本公认的奠基之作。最早是1980年，两位语言学家George Lakoff和Mark Johnson写了《我们赖以生存的隐喻》（Metaphors We Live By），论证人的概念系统是从身体经验里长出来的。我们说"心情很高"、"情绪低落"，这个"高"和"低"就来自身体对上下的体验。1991年，Francisco Varela等三人的《具身心智》（The Embodied Mind）第一次系统提出了"具身认知"这条路径。到1997年，哲学家Andy Clark的《Being There》更进一步，直接把具身认知接到了人工智能和机器人上，主张认知是大脑、身体和环境合力"撑"起来的，单靠一个大脑撑不住。Clark这本书也成了认知科学这一层通向下面工程实践的桥。

最上面一层才是AI和机器人。真正把"具身"从哲学口号变成工程主张的，是MIT的Rodney Brooks，时间是1980年代末到90年代。

三层叠下来，结论很清楚：这是三十多年的老思想，被2023年后的产业热潮重新捡了起来。

我之所以要先把这层历史摆出来，是因为它能帮你校准对当下热潮的判断。如果"具身智能"是个全新概念，那满天飞的热词或许真预示着某种突破。可一旦你知道这套思想三十多年前就被反复琢磨过、也反复碰过壁，你看那些"颠覆性进展"的眼光就会冷静很多。哪些是真新东西，哪些只是老问题换了个时髦说法，得有这层历史垫底才分得清。下面两节，看看早期的人具体是怎么折腾的。
...
它栽在哪？三个坑。一是框架问题，世界一变，符号模型就得全部重算，可现实是无时无刻不在变。二是组合爆炸，稍微复杂一点的环境，要考虑的可能性就指数级膨胀，算不过来。三是把整个世界都转成符号再推理这件事本身，又慢又脆，现实里一个没预料到的小石子就能让它彻底卡死。
...
Rodney Brooks看不下去了。他在1986年的论文里提出了一个针锋相对的架构，叫包容架构（subsumption architecture）。
...
2017年，Google的八个人发了篇叫《Attention Is All You Need》的论文，提出了Transformer架构。这玩意儿后来撑起了整个大模型时代，也顺着一条清晰的链条爬进了机器人。

这条链条是这样的：Transformer先是被用到了视觉上，2020年提出、2021年正式发表在ICLR的Vision Transformer（ViT）让它学会了看图。接着视觉和语言被打通，出现了视觉语言模型（VLM），既能看图又能懂文字。最后再往上接一层，让它能输出动作，就成了VLA，视觉语言动作模型（Vision-Language-Action）。
...
这里有个常被搞错的点要说清楚。RT-1（2022年底）经常被人当成第一个VLA，其实不是。RT-1只是把机器人的输入输出转成了token交给Transformer处理，它并没有把互联网级的视觉语言知识接进来，业内不把它算作VLA，它是VLA的前身和铺垫。

真正让VLA成立的是2023年7月Google DeepMind的RT-2。"视觉语言动作模型"这个术语，正是RT-2的论文提出来的。从RT-2起，这套范式才算正式开张。算下来，VLA这套东西到现在也就三年，非常年轻。
