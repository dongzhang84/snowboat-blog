...
📍 范围：这份名单以美国和西方 AI 圈为主。中国那边的生态、谁该排进来、按什么排，我自己没把握，所以这里不展开，免得乱排误导人。

⚠️ 提醒：2025–2026 年是 AI 人才流动最疯狂的两年，跳槽、创业、被反向收购几乎每周都在发生。下面的"现状"尽量取最新，但很可能很快过期，这是一份"活名单"，建议你自己随时往里加、往里改。
...
- Geoffrey Hinton @geoffreyhinton
  反向传播、深度学习"教父"。2018 图灵奖、2024 诺贝尔物理奖。已离开 Google（2023），专注呼吁 AI 风险。

- Yann LeCun @ylecun
  卷积网络之父，2018 图灵奖。2025 年 11 月离开 Meta，创办 AMI Labs（世界模型，2026 年 3 月融资超 10 亿美元）。

- Yoshua Bengio @Yoshua_Bengio
  深度学习先驱，2018 图灵奖。Mila 创始人，2025 年创办 LawZero，任《国际 AI 安全报告》主席。

- Richard Sutton @RichardSSutton
  强化学习奠基、经典教材作者，2024 图灵奖。University of Alberta / Keen Technologies。

- Andrew Barto
  强化学习奠基，2024 图灵奖。UMass Amherst（荣休）。

- Jürgen Schmidhuber @SchmidhuberAI
  LSTM，常公开争论"原创权"。KAUST / IDSIA。

- Jeff Dean @JeffDean
  Google Brain、MapReduce、TensorFlow。现 Google DeepMind 首席科学家。

- Ian Goodfellow @goodfellow_ian
  GAN 发明者。2025 年离开 Google，创业中（stealth）。

- Andrew Ng @AndrewYNg
  Google Brain 联创、Coursera，最知名 AI 教育者。现做 DeepLearning.AI、AI Fund。

- Fei-Fei Li @drfeifei
  ImageNet、"AI 教母"。Stanford，World Labs（空间智能，2026 年 2 月融资约 10 亿美元）。

- Daphne Koller @DaphneKoller
  概率图模型、Coursera 联创。现 insitro（AI 制药）创始 CEO。

- Michael I. Jordan
  机器学习理论泰斗。Berkeley / Inria Paris。


# 二、前沿大模型实验室创始人 / 领袖

- Sam Altman @sama
  OpenAI CEO，创业/投资出身（非学术），行业最具影响力 CEO。在任。

- Greg Brockman @gdb
  OpenAI 总裁、联合创始人。在任。

- Ilya Sutskever @ilyasut
  OpenAI 前首席科学家。创办 Safe Superintelligence（SSI），估值约 320 亿美元。

- Mira Murati @miramurati
  OpenAI 前 CTO。创办 Thinking Machines Lab（2026 初经历高管出走动荡）。

- Dario Amodei @DarioAmodei
  Anthropic CEO、联合创始人。在任。

- Daniela Amodei @DanielaAmodei
  Anthropic 总裁、联合创始人。在任。

- Demis Hassabis @demishassabis
  Google DeepMind CEO，2024 诺贝尔化学奖（AlphaFold）。在任。

- Shane Legg @ShaneLegg
  DeepMind 联合创始人、首席 AGI 科学家。在任。

- John Jumper @JohnJumperSci
  AlphaFold，2024 诺贝尔化学奖。2026 年 6 月宣布离开 DeepMind 加入 Anthropic。

- Elon Musk @elonmusk
  xAI 创始人、OpenAI 早期出资人（非学术）。在任（2026 年 xAI 并入 SpaceX）。

- Igor Babuschkin @ibab
  xAI 联合创始人。2025 年离开 xAI，创办 Babuschkin Ventures、River AI。

- Arthur Mensch @arthurmensch
  Mistral AI 创始 CEO（前 DeepMind）。在任，欧洲开源旗手。

- Emad Mostaque @EMostaque
  Stability AI 创始人（Stable Diffusion）。已离开 Stability，创办 Intelligent Internet。

- Aravind Srinivas @AravSrinivas
  Perplexity AI 创始 CEO。在任。

- Mustafa Suleyman @mustafasuleyman
  DeepMind 联创、Inflection 创始。现任 Microsoft AI CEO。

- Alexandr Wang @alexandr_wang
  Scale AI 创始人（MIT 辍学，非学术）。2025.6 任 Meta 首位首席 AI 官，领导 Meta Superintelligence Labs。

- Shengjia Zhao @shengjia_zhao
  ChatGPT / GPT-4 共同创造者。Meta Superintelligence Lab 首席科学家。

- Daniel Gross @danielgross / Nat Friedman @natfriedman
  AI 投资人组合，曾被各大厂争抢。现均加入 Meta Superintelligence Labs。

- Liang Wenfeng（梁文锋）
  DeepSeek 创始人，量化金融/工程出身。在任。

- Yang Zhilin（杨植麟）
  Moonshot AI（Kimi）创始人。在任（2026 年估值约 200 亿美元）。

- Jakub Pachocki @merettm
  OpenAI 首席科学家。2024 年 5 月接替 Ilya 至今。

- Mark Chen @markchen90
  OpenAI 首席研究官（CRO）。2025 年 3 月升任。

- Oriol Vinyals @OriolVinyalsML
  Google DeepMind 研究副总裁，Gemini 技术共同负责人。在任。

- David Silver @dsilver829
  AlphaGo/AlphaZero 核心，DeepMind 强化学习负责人。2026 年初创办 Ineffable Intelligence（11 亿美元种子轮）。


# 三、Transformer 论文《Attention Is All You Need》八位作者

- Ashish Vaswani @ashVaswani
  论文第一作者。创办 Adept（失败），现创办并执掌 Essential AI。

- Noam Shazeer @NoamShazeer
  MoE、Character.AI。2026.6 离开 Google 加入 OpenAI。

- Niki Parmar @nikiparmar09
  论文核心作者。创办 Adept、Essential AI 后，转任 Anthropic 技术员工。

- Jakob Uszkoreit @kyosu
  论文作者。创办 Inceptive（用 AI 设计 RNA / 生物医药）。

- Llion Jones @YesThisIsLion
  论文作者。联合创办 Sakana AI（日本，独角兽）。

- Aidan Gomez @aidangomez
  最年轻作者（当时本科生）。联合创办并执掌 Cohere（估值约 70 亿美元）。

- Łukasz Kaiser @lukaszkaiser
  论文作者、Tensor2Tensor。OpenAI 研究员（八人中唯一没创业的）。

- Illia Polosukhin @ilblackdragon
  论文作者。联合创办 NEAR Protocol（区块链）。


# 四、学术界顶尖研究者（高产、高引用、常被引用为"大 V"）

- Christopher Manning @chrmanning
  Stanford。NLP 泰斗、GloVe。

- Percy Liang @percyliang
  Stanford。基础模型评测、CRFM。

- Chris Ré
  Stanford。数据/系统，Together AI 联创。

- Pieter Abbeel @pabbeel
  Berkeley / Amazon AGI。机器人 / RL，Covariant 创始。
...
- Kaiming He（何恺明）
  MIT（前 FAIR）。ResNet、MAE，CV 被引王。

- Ross Girshick @inkynumbers
  R-CNN 系列。

- Alexei Efros @AlexeiEfros
  Berkeley。视觉、生成。

- Regina Barzilay @BarzilayRegina
  MIT。AI + 医疗/药物。
...
- Max Tegmark @tegmark
  MIT。物理 + AI、Future of Life Institute。

- Zoubin Ghahramani @ZoubinGhahrama1
  Cambridge / Google。贝叶斯机器学习。

- Noah Smith @nlpnoah
  UW / AI2。NLP。

- Yejin Choi @YejinChoinka
  Stanford（前 UW/AI2）。常识推理 NLP。

- Sebastian Thrun @SebastianThrun
  Stanford。自动驾驶、Udacity 创始。
...
- Alec Radford @AlecRad
  独立研究 / Thinking Machines 顾问。GPT / GPT-2 / CLIP / Whisper 主作者，业内公认最被低估的关键人物。

- John Schulman @johnschulman2
  Thinking Machines（前 OpenAI/Anthropic）。PPO、ChatGPT 共同创造者。

- Noam Brown @polynoamial
  OpenAI。博弈/推理，o 系列推理模型关键人。

- Jared Kaplan
  Anthropic 联合创始人。Scaling Laws（物理学家出身）。

- Tom Brown @nottombrown
  Anthropic 联合创始人。GPT-3 负责人。

- Chris Olah @ch402
  Anthropic 联合创始人。可解释性研究奠基。

- Robin Rombach @robrombach
  Black Forest Labs 创始。Stable Diffusion 主作者，现做 FLUX。

- Aditya Ramesh @model_mechanic
  OpenAI（VP Research，Sora/Worldsim）。DALL·E 主作者。

- Jonathan Ho
  扩散模型 DDPM 奠基。

- Jason Wei @_jasonwei
  Meta（前 OpenAI/Google）。Chain-of-Thought、涌现能力。

- Denny Zhou @denny_zhou
  Google DeepMind。LLM 推理（CoT、自洽性）。

- Quoc Le @quocleix
  Google DeepMind。seq2seq、AutoML、AlphaGeometry。


# 五、教育 / 科普 / 内容型大 V（"会讲"比"会做"更出圈）

- Andrej Karpathy @karpathy
  前 Tesla AI 总监、OpenAI 创始成员。YouTube/X 顶流讲师，"AI 科普第一人"。创办 Eureka Labs，2026.5 暂停后加入 Anthropic。

- Jeremy Howard @jeremyphoward
  fast.ai 创始，最受欢迎的实战课。

- Lex Fridman @lexfridman
  MIT 背景。头部 AI / 科技长访谈播客。

- Grant Sanderson（3Blue1Brown） @3blue1brown
  神经网络可视化讲解殿堂级。

- Yannic Kilcher @ykilcher
  论文精读 YouTube 大 V。

- Károly Zsolnai-Fehér（Two Minute Papers） @karoly_zsolnai
  "论文两分钟"科普。
...
- Shawn Wang（swyx） @swyx
  "AI 工程师"概念推手、Latent Space 播客。

- Ethan Mollick @emollick
  沃顿商学院教授，《Co-Intelligence》作者，AI 改变工作/教育的头部解读者。

- Simon Willison @simonw
  Django 联合创造者，"prompt injection"提出者，LLM 实战与安全。

- Riley Goodside @goodside
  prompt injection / jailbreak 早期代表，实践型。


# 六、开源 / 工程 / 框架基础设施

- Clément Delangue @ClementDelangue
  Hugging Face 联合创始 CEO。在任，开源社区中枢。

- Thomas Wolf @Thom_Wolf
  Hugging Face 联合创始、首席科学家。在任。

- Soumith Chintala @soumithchintala
  PyTorch 共同创造者。2025 年离开 Meta，任 Thinking Machines Lab CTO。

- François Chollet @fchollet
  Keras 作者、ARC 挑战赛。离开 Google 创业（Ndea）。

- Georgi Gerganov @ggerganov
  llama.cpp / ggml 作者。ggml.ai（2026 并入 Hugging Face）。

- Tianqi Chen @tqchenml
  XGBoost、TVM、MLC。CMU / Nvidia（OctoAI 2024 被 Nvidia 收购）。

- Jim Fan @DrJimFan
  具身智能/机器人科普大 V。NVIDIA GEAR 实验室。

- Tri Dao @tri_dao
  FlashAttention 作者。Princeton / Together AI。

- Wes McKinney @wesmckinn
  pandas 创造者。

- Travis Oliphant @teoliphant
  NumPy/SciPy。Quansight。

- Lin Qiao @lqiao
  PyTorch 团队、Fireworks AI 创始。在任。

- vLLM 团队
  高性能推理。开源/学界。

- Harrison Chase @hwchase17
  LangChain 创始人、CEO。2025 年估值 12.5 亿美元。

- Jerry Liu @jerryjliu0
  LlamaIndex 创始人、CEO。RAG / 文档 agent 生态。


# 七、AI 安全 / 治理 / 思想类大 V

- Stuart Russell
  经典教材《AIMA》作者、AI 安全旗手。
...
- Paul Christiano @paulfchristiano
  RLHF、对齐研究、美国 AI 安全研究所。

- Jan Leike @janleike
  前 OpenAI 超级对齐负责人，现 Anthropic。
...
- Leopold Aschenbrenner @leopoldasch
  《Situational Awareness》作者，前 OpenAI 超级对齐，创办 AI 主题对冲基金。

- Amanda Askell @AmandaAskell
  Anthropic，Claude 人格与偏好，HHH 框架共同作者。

- Sam Bowman @sleepinyourhat
  NLP/评测/AI safety，NYU + Anthropic。

- Jack Clark @jackclarkSF
  Anthropic 联创，Import AI，政策影响力。

- Dan Hendrycks @DanHendrycks
  CAIS 主任，AI 风险与评测（MMLU/MATH）。

- Dean Ball @deanwball
  AI 政策。2026 加入 OpenAI Strategic Futures。
...
- Kevin Scott @kevin_scott
  Microsoft CTO，微软 AI 战略操盘手。

- Brad Lightcap @bradlightcap
  OpenAI COO。

- Mike Krieger @mikeyk
  Instagram 联创，现 Anthropic 首席产品官。

投资人 / 孵化器

- Marc Andreessen @pmarca / Vinod Khosla @vkhosla
  顶级 AI 风投。

- Masayoshi Son @masason
  SoftBank，AI 超级投资人。

- Eric Schmidt @ericschmidt
  前 Google CEO，现顶级 AI 投资与政策玩家。

- Reid Hoffman @reidhoffman
  LinkedIn 创始、Inflection 联创、超级投资人。

- Garry Tan @garrytan
  Y Combinator 总裁（孵化器之王）。

- Sarah Guo @saranormous
  Conviction 创始人、AI 风投与播客。

应用 / 工具 / 芯片 / 机器人创始人（连续创业者，非学术）

- Michael Truell @mntruell
  Anysphere / Cursor 创始 CEO（当下最火编程工具）。

- Scott Wu @ScottWu46
  Cognition 创始 CEO（Devin）。
...
- Andrew Feldman @andrewdfeldman
  Cerebras 创始 CEO（AI 芯片）。

- Brett Adcock @adcock_brett
  Figure AI 创始人（人形机器人）。

- Marc Raibert
  Boston Dynamics 创始人（机器人奠基）。
...
把上面八类一百三十多人盘下来，规律很清楚。定义AI的人，绝大多数是学术和研究出身，真正"做生意起家"的是少数。

最硬的证据在前四类。深度学习教父、前沿实验室的首席科学家、Transformer的八位作者、学术界顶尖研究者，这四组加起来七十多人，几乎清一色PhD或研究员出身，很多还出自同一批实验室（OpenAI、Google Brain、DeepMind、FAIR）和同几所学校（斯坦福、伯克利、MIT、多伦多）。这个圈子里的硬通货是论文和代表作，不是文凭上的MBA。

把"创始人"和"科学家"分开看更清楚。今天这些明星公司的创始人，大部分本来就是研究员，被资本和时代推着下了海。Hassabis、李飞飞、Bengio、Ilya、David Silver、Arthur Mensch、Tri Dao，都是先有学术身份，再有公司。"学者下海"才是这一波创业潮的主线。
