...
两边都不是完美的。前一种可能让美国在全球AI竞争里反应僵化，后一种短期内对底层劳动者保护弱。但两边都比"反AI"这种口号实在，因为它们关心的都是"AI应该如何融入社会"这个具体问题，跟"AI该不该存在"这种哲学讨论是两个层面。

这场对AI的反感真正应该被引导去的方向，是上面这一层。无论是pro-AI派还是anti-AI派，无论是左派还是右派，在这一层上都能找到自己的论据和路径。

# 五、西方反技术文化的两个原型

这场对AI的反感为什么在美国特别强烈？

要回答这个问题，得先看到一件事：西方流行文化里有一条贯穿两百年的反技术叙事主线，好莱坞把它放大成了几代美国人的本能反应。AI只是这条主线最新的载体。

这条主线起头是1818年玛丽·雪莱的《弗兰肯斯坦》。20世纪前半段它在欧美舞台和银幕上被反复重写：1920年捷克剧作家恰佩克（Karel Čapek）的舞台剧《R.U.R.》第一次造出"robot"这个词，剧情是人造工人造反杀光人类；1927年弗里茨·朗（Fritz Lang）的德国电影《大都会》（Metropolis）让银幕第一次出现取代真人的女性机器人，把"机器替身煽动暴乱"这条剧情线立了起来；1936年卓别林（Charlie Chaplin）的《摩登时代》（Modern Times）把流水线工人塞进齿轮，成为"人被机器吞掉"的标志性画面。1968年库布里克（Stanley Kubrick）的《2001太空漫游》把这条主线推进到"会说话的AI"形态，HAL 9000往后又派生出Terminator、The Matrix、Ex Machina、Westworld。

整条线两百年没断过。这一章我们挑两个最有结构性的锚点做切片：1818年的弗兰肯斯坦（这条主线的源头）和1968年的HAL（这条线进入"AI"形态的转折点）。两个锚点之间和之后还有大量其它作品，下面这两个不是全部，只是最便于解释今天美国年轻人那场嘘声的两个切片。
...
把弗兰肯斯坦和HAL放在一起看，能看出来一件事：对AI的恐惧，里面相当大一部分是从两百年文化里继承的剧本，只是把这一轮的技术名词换成了"AI"。

历史上每隔几十年都会经历一次类似的循环。同一套话术模板，每一代把里面的关键词换掉再用一遍：

- **"它会偷走我们的工作"**：1810年代英国卢德派砸毁纺织机的时候是这句；1880年代电力进入工厂的时候是这句；1950年代自动化论战（诺伯特·维纳那一拨）是这句；1990年代外包印度、东欧是这句；2026年反AI还是这句。
- **"它会让人类变蠢"**：柏拉图在《斐德罗篇》里担心写作会毁掉记忆是这句；19世纪反对小说和报纸是这句；1960年代电视被叫做"巨大的荒原"是这句；反对计算器、维基百科、智能手机都是这句；今天反对ChatGPT还是这句。
- **"它会摧毁人类的创造力"**：摄影出现时画家说过这句；电影出现时戏剧人说过这句；1980年代电子合成器进入流行音乐时音乐家说过这句；Photoshop刚出现时插画家说过这句；今天反对AI生成内容还是这句。
- **"它会让人彼此孤立"**：电话普及时担心的是这句；电视进家庭时担心的是这句；电子游戏出现时担心的是这句；互联网出现时担心的是这句；智能手机普及时担心的是这句；今天AI陪伴应用出现还是这句。
- **"机器会反过来杀人类"**：弗兰肯斯坦讲的是这句；《大都会》讲的是这句；《2001太空漫游》讲的是这句；Terminator、Matrix、Ex Machina讲的是这句；今天Hinton、Yudkowsky警告AI对齐风险讲的还是这句。

每一轮新技术冲到台前，这套模板就被取出来，把名词换成新的，重新用一遍。AI不是第一个被装进这些模板的东西，以前每一种新技术都被装过。模板本身经过六七代验证仍然在用，说明它对应着人类的某种心理结构：对未知的恐惧、对掌控的渴望、对失去工作和尊严的焦虑。这种心理结构是真实的。但模板的有效，跟"这一次AI真的会怎样"是两个层面的问题。

另一件需要说清楚的事：这套剧本不是年轻人独有。

毕业典礼台下嘘的是毕业生不假，但整个反AI叙事的主要供给方反而集中在中老年知识分子身上：Geoffrey Hinton（78岁，2024年诺贝尔物理奖得主）用弗兰肯斯坦模板警告AI存在风险等级的威胁；Yuval Harari（50岁的历史学家）在畅销书里讲AI接管人类用的也是这个模板；Stephen Hawking生前的AI警告、Elon Musk反复发的AI末日推特，都在不同程度上用过这个模板。这些人都已经远离年轻人范畴，却仍然在向公共讨论里持续供给反AI叙事的话术弹药，今天年轻人嘘声里那些词，大部分是从他们那里继承下来的。

Pew Research的多轮调查显示，对AI的担忧并不集中在某个年龄段，而是横跨所有年龄。在很多调查项目上，中老年人的担忧反而比年轻人更深。年轻人因为毕业典礼这种集体场合，反感容易被看见；中老年人因为分散在家庭、办公室、社论里，反感被消化掉。但底层那套叙事是同一套。
...
美国2026年这场对AI的反感，在东亚找不到对应。同一时期，中国、日本、韩国对AI的整体态度反而是拥抱的：把AI当成可以学习、可以驾驭、可以用来改变自己处境的工具。两边的反差不在温度上的强弱，而在方向上的相反。这种相反不是2026年突然出现的，要追到19世纪中叶东亚被迫开国的那段历史。
...
美国流行文化里也有正面的机器人形象，但绝大多数在儿童片/家庭片定位上：皮克斯的 Wall-E、《铁巨人》、《超能陆战队》的大白、《星球大战》的 R2-D2 和 C-3PO、《霹雳五号》的 Johnny 5、《星际迷航》里的 Data。但在成人科幻主线里，从 Frankenstein 到 Terminator 到 Matrix 到 Ex Machina,几乎一面倒是反派。阿童木和哆啦A梦在日本不是儿童片专属，它们是国民级文化主角，这种定位差异比"有没有正面机器人"更说明问题。

后果今天能看见。日本工业自动化率全球前列，工厂里机器人臂随处可见，从未出现卢德运动式的有组织抵抗。日本的便利店、机场、酒店越来越多用机器人接待，公众反应是好奇而不是恐惧。

## 6.3 中国学生今天的反应：怕被甩在AI之后

中国大学生今天对AI的态度，跟美国年轻人不是镜像。它更像把"技术是阶梯"那段历史叙事直接搬到了2026年。

2024年《每日经济新闻》对370名中国大学生做的调查里，57.3%选择"非常拥抱、乐于尝试AI"，只有6%选择"非常焦虑，担心被AI取代"。另一份2024年的调查里，92.4%的中国大学生支持AI技术广泛应用，7.6%反对。同期美国Gen Z里有42%认为AI会损害自己的工作机会。两边的位置反过来了。

但这不意味着中国大学生没有焦虑。焦虑的方向跟美国正好相反。中国学生怕的是自己跟不上AI、被这一波技术甩到后面去，而非担心AI会跑过来抢自己的工作。

2025年9月发布的《2025年大学生AI使用心态洞察报告》里43.5%的受访学生存在不同程度的AI焦虑。展开看具体焦虑内容，62.3%担心"过度依赖AI导致思维懒惰"，53.7%担心"对AI产生情感依托"，46.3%担心"影响现实社交能力"。这些表面上是认知层面的担忧，根子上还是"我会不会用得没别人快、被那些用得更好的人甩开"的位置焦虑。文史哲专业学生焦虑感最明显（48.4%存在AI焦虑），原因也跟反AI无关，是觉得自己手里的工具不如理工科同学，在浪潮里位置最被动。

这个焦虑的对面挂着的是另一句话，中文里叫"逆天改命"。在中国语境里这是个相当强的词，意思是用一个新工具把命运里那些原本固化的东西撬开：出身、户籍、毕业院校、家庭资源。AI被相当一部分中国学生当成了这种工具。

具体路径长这样：中国体制内的传统赛道（高考、公务员考试、传统大厂校招）的位置已经被前面几届占满了，内卷收益递减。但AI同时开辟了一批新的前端生态位：做AI agent的独立开发者、用Cursor做超薄应用并独立运营、做AI内容创作者、把AI能力嵌入跨境电商和供应链、做行业垂类AI、给海外做AI咨询。这些生态位都还没有形成稳定的人才梯队，先冲进去的人能拿到不对称收益。中国大学生里对AI最热情、最不焦虑的那一群，基本都在朝这些方向冲。

这也解释了一个有意思的数据反差：中国大学生对AI态度越正面，求职焦虑反而越低；美国正好相反，越深入用AI的人对AI兴奋度反而越低。两条曲线方向相反，背后是对同一种工具的两套不同预设：中国学生把AI当成可以登顶的阶梯，美国学生把它当成站在面前的对手。
...
四层反感都有真实的数据和具体的处境支撑。把这场反感简单总结成"美国年轻人不懂技术只会乱叫"，是对这一代人处境的轻视。但把"反对AI"作为对这四层问题的总解药，会一个都解决不了。真正能动的是劳动政策、教育评估、版权法、平台问责。这些事需要pro-AI派和anti-AI派、左派和右派的共同参与。

写到结尾，我不想替读者下一个最终判断。下面这些问题留给每个角色自己回答。

**如果你是2026年那个22岁的毕业生**

- 你坐在亚利桑那大学橄榄球场听到施密特那句"上火箭吧"的那一刻，你的不爽里，几层是技术真实带来的？
- 几层是从《2001太空漫游》和儿时电影里继承下来的剧本？
- 把这两层分开之后，你对AI的真正立场会变成什么样？
- 如果禁ChatGPT既不能让一份大科技offer长回来，又不能让你的学贷少一分，你真正应该向谁施压？

**如果你是2026年的Schmidt、Borchetta、Caulfield**

- 你在台上说"AI是机会"那一刻，考虑过台下听众面对的招聘市场吗？
- 你愿意把自己几百亿身家里的一小部分，投到能让这一代年轻人不那么焦虑的事情上吗？比如再培训补贴、过渡期失业保险、AI对教育评估的重新设计研究。
- 你下一次再上台说同一句话之前，能不能先把这些具体的事讲清楚？

**如果你是2026年的大学校长**

- 你的学校在向学生收每年8万美元学费的同时，是不是也在悄悄用AI替代以前需要人做的工作？
- 你能不能跟学生开诚布公讲一遍：哪些环节用了AI、原因是什么、这些省下来的钱去了哪里？
- 评估方式的重新设计（口试、过程文档、项目答辩），你的学校真的在推，还是只挂在PPT上？

**如果你是反AI派的中老年知识分子**

- 你呼吁的具体问题是哪一层（生计/学校/尊严/消费）？你给出的方案是政府介入这条路，还是市场化那条路？
- 你描绘的恐惧画面里，有多少是真实数据支撑的，有多少是从《弗兰肯斯坦》《大都会》《2001太空漫游》继承下来的剧本？
- 同一套话术模板在反对电力、计算器、互联网时也都用过，这一次为什么不一样？请给出具体证据。

**如果你是一个普通读者**

- 下一次看到一条"AI又怎样了"的新闻，请先问自己：被讨厌的是技术本身，还是某种特定的部署方式？
- 这条新闻讲的是AI能力问题，还是部署AI的人选了最便宜的做法？
- 它用的是数据，还是话术模板？如果是模板，这同一套模板上一次被装上去的技术名词是什么？

这些问题没有标准答案。但分得清楚它们之间的差别，是这场讨论能往前走的唯一办法。

毕业典礼的嘘声会继续。到了明年2027年的毕业季，台下大概率还会嘘AI。但嘘声本身不会改变什么。能改变的是嘘声之后那些更安静、更具体的工作：起诉、立法、谈判、重新设计课程、重新分配预算。

那些工作不上头条，却是真正动这件事的地方。
