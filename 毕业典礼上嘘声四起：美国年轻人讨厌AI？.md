...
一类是**AI能力问题**。今天的大模型在事实准确性、长文本理解、跨上下文一致性、罕见姓名发音上仍然不够好。Google AI概览的错误率37%、AI客服听不懂复杂问题、AI朗读把华人名字念错，这些是技术本身还没到位。它们会随着模型迭代而改善：GPT-5、Claude 5、Gemini 3每一轮都在压低错误率，过两三年这一层抱怨会自然减少一档。

另一类是**部署AI的人的问题**。一家公司明明知道当前AI客服会丢单、AI朗读会念错名字、AI总结会传错信息，仍然选择上线，因为换成人贵。一所学校明明可以请一个朗读员花200美元朗读名字，仍然选择免费的AI，因为想省钱。这一类的责任在人，不在AI。AI再进步10倍，懒惰部署仍然会用AI能力的下限做最便宜的服务。
