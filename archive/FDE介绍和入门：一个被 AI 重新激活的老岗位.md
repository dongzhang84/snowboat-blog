...
如果只看“驻场”，FDE一点都不新。ERP（Enterprise Resource Planning，企业资源计划）是一类企业管理软件系统，通常用来管理财务、采购、库存、生产、人力和供应链这些核心流程。ERP实施顾问干了几十年，硬件公司的FAE也干了几十年，咨询公司也早就会派人进客户办公室。中国企业软件里更常见，项目一启动，一堆实施、开发、测试、项目经理就住进客户现场。
...
这个岗位最适合的第一类人，是有生产经验的软件工程师，愿意走向客户和业务。你已经会写后端、接API、做权限、看日志、排生产事故，缺的是业务现场。对这类人来说，最大的转变是从框架学习转向现场推进，习惯在需求不清、数据不干净、客户内部意见不一致的情况下把系统上线。

第二类人，是有ToB交付经验的人，尤其是做过实施、售前方案、客户成功、数据项目、RPA项目的人。你们知道企业客户不会按文档说话，知道一个字段口径能吵三周，也知道上线验收背后有预算、责任和部门关系。你们要补的是工程深度，至少要能独立读代码、改接口、理解系统架构，不能只停留在会议、配置和项目管理层。

第三类人，是有深行业知识的人。比如你长期在金融风控、医疗运营、供应链、制造、教育、法律、财税这些行业里做一线工作，知道真实流程怎么跑，知道哪些异常最贵，知道哪些话不能让AI乱说。你未必一开始就是强工程师，但如果愿意补系统集成、数据结构和AI工程，你的行业判断会很值钱。因为FDE最难的部分，经常在定义什么叫做对，接模型只是其中一步。

反过来，有几类人不适合一上来就冲FDE。只会写demo的人不适合，客户最后要买上线后的稳定性和责任边界。只会讲方案的人也不适合，因为FDE最后要交付能跑的系统。只懂模型、不懂企业流程的人同样会吃亏，因为真实项目里最麻烦的部分往往是权限、数据、审计、合规和人。

普通人如果想试水，不要先去包装简历里的FDE标签。更好的做法，是选一个足够窄的真实场景，做一个能被真实用户每天使用的小系统。比如帮一个小团队自动整理客服工单，帮一家店做库存和补货提醒，帮一个销售团队把CRM字段补齐，帮一个律所做合同条款初筛。

这个项目不需要一开始很大，但必须有生产味。你要留下需求拆解、数据来源、权限设计、失败样本、eval标准、灰度上线记录和用户反馈。哪怕只服务了一个真实客户，这套材料也比十个漂亮demo更能说明你理解FDE。

判断自己有没有接近FDE，可以问三个问题。第一，你能不能把一句“我想用AI提升效率”拆成五到十个具体业务动作？第二，你能不能说清楚每个动作的风险、权限、验收标准和回滚办法？第三，你能不能把一次交付里的重复问题沉淀成下一次能复用的模板？

这三个问题答不上来，说明你还在工具层。答得上来，哪怕你title还不是FDE，你已经在做FDE式工作。
