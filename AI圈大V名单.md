...
| 姓名 | 背景 | 公司/角色 | 现状 |
|---|---|---|---|
| Sam Altman | 创业/投资（非学术） | OpenAI CEO | 在任，行业最具影响力 CEO |
| Greg Brockman | 工程 | OpenAI 总裁、联合创始人 | 在任 |
| Ilya Sutskever | 学术 | OpenAI 前首席科学家 | 创办 Safe Superintelligence (SSI)，估值约 320 亿美元 |
| Mira Murati | 工程/产品 | OpenAI 前 CTO | 创办 Thinking Machines Lab（2026 初经历高管出走动荡） |
| Dario Amodei | 学术 | Anthropic CEO、联合创始人 | 在任 |
| Daniela Amodei | 业界 | Anthropic 总裁、联合创始人 | 在任 |
| Demis Hassabis | 学术 | Google DeepMind CEO；2024 诺贝尔化学奖（AlphaFold） | 在任 |
| Shane Legg | 学术 | DeepMind 联合创始人、首席 AGI 科学家 | 在任 |
| John Jumper | 学术 | AlphaFold、2024 诺贝尔化学奖 | DeepMind（有报道称 2026 年转投 Anthropic，待确认） |
| Elon Musk | 创业（非学术） | xAI 创始人、OpenAI 早期出资人 | 在任 |
| Igor Babuschkin | 学术 | xAI 联合创始人 | 在任 |
| Arthur Mensch | 学术 | Mistral AI 创始 CEO（前 DeepMind） | 在任（欧洲开源旗手） |
| Emad Mostaque | 业界 | Stability AI 创始人（Stable Diffusion） | 已离开 Stability，另起新项目 |
| Aravind Srinivas | 学术 | Perplexity AI 创始 CEO | 在任 |
| Mustafa Suleyman | 业界 | DeepMind 联创、Inflection 创始 | 现任 Microsoft AI CEO |
| Alexandr Wang | 创业（非学术，MIT 辍学） | Scale AI 创始人 | 2025.6 任 Meta 首位首席 AI 官，领导 Meta Superintelligence Labs |
| Shengjia Zhao | 学术 | ChatGPT / GPT-4 共同创造者 | Meta Superintelligence Lab 首席科学家 |
| Daniel Gross / Nat Friedman | 投资/工程 | AI 投资人组合，曾被各大厂争抢 | 现均加入 Meta Superintelligence Labs |
| Liang Wenfeng | 量化金融/工程 | DeepSeek 创始人 | 在任（中国开源模型代表） |
| Yang Zhilin | 学术 | Moonshot AI（Kimi）创始人 | 在任 |
...
|---|---|---|---|
| Ashish Vaswani | 学术 | 论文第一作者 | 创办 Adept（失败）→ 现创办并执掌 Essential AI |
| Noam Shazeer | 学术/工程 | MoE、Character.AI | 几天前（2026.6）离开 Google 加入 OpenAI |
| Niki Parmar | 学术 | 论文核心作者 | 创办 Adept、Essential AI 后，转任 Anthropic 技术员工 |
| Jakob Uszkoreit | 学术 | 论文作者 | 创办 Inceptive（用 AI 设计 RNA / 生物医药） |
| Llion Jones | 学术 | 论文作者 | 联合创办 Sakana AI（日本，独角兽） |
| Aidan Gomez | 学术（当时本科生） | 最年轻作者 | 联合创办并执掌 Cohere（估值约 70 亿美元） |
| Łukasz Kaiser | 学术 | 论文作者、Tensor2Tensor | OpenAI 研究员（八人中唯一没创业的） |
| Illia Polosukhin | 学术/工程 | 论文作者 | 联合创办 NEAR Protocol（区块链） |
...
| 姓名 | 机构 | 方向/代表作 |
|---|---|---|
| Christopher Manning | Stanford | NLP 泰斗、GloVe |
| Percy Liang | Stanford | 基础模型评测、CRFM |
| Chris Ré | Stanford | 数据/系统、Together AI 联创 |
| Pieter Abbeel | Berkeley | 机器人 / RL；Covariant 创始 |
| Sergey Levine | Berkeley | 深度强化学习、机器人 |
| Dawn Song | Berkeley | AI 安全与隐私 |
| Jitendra Malik | Berkeley | 计算机视觉奠基 |
| Kaiming He | MIT（前 FAIR） | ResNet、MAE，CV 被引王 |
| Ross Girshick | — | R-CNN 系列 |
| Alexei Efros | Berkeley | 视觉、生成 |
| Regina Barzilay | MIT | AI + 医疗/药物 |
| Tommi Jaakkola | MIT | 机器学习理论、扩散模型 |
| Max Tegmark | MIT | 物理 + AI、Future of Life Institute |
| Zoubin Ghahramani | Cambridge / Google | 贝叶斯机器学习 |
| Noah Smith | UW / AI2 | NLP |
| Yejin Choi | Stanford（前 UW/AI2） | 常识推理 NLP |
| Sebastian Thrun | Stanford | 自动驾驶、Udacity 创始 |
| Jeff Clune | UBC / DeepMind | 开放式学习 |
| Chelsea Finn | Stanford | 元学习、机器人 |
| Tatsunori Hashimoto | Stanford | 语言模型评测/对齐 |
| Alec Radford | OpenAI（2025 已离开） | GPT / GPT-2 / CLIP / Whisper 主作者，业内公认最被低估的关键人物 |
| John Schulman | Thinking Machines（前 OpenAI/Anthropic） | PPO、ChatGPT 共同创造者 |
| Noam Brown | OpenAI | 博弈/推理、o 系列推理模型关键人 |
| Jared Kaplan | Anthropic 联合创始人 | Scaling Laws（物理学家出身） |
| Tom Brown | Anthropic 联合创始人 | GPT-3 负责人 |
| Chris Olah | Anthropic 联合创始人 | 可解释性研究奠基 |
| Robin Rombach | Black Forest Labs 创始 | Stable Diffusion 主作者，现做 FLUX（研究者+创始人） |
| Aditya Ramesh | Thinking Machines（前 OpenAI） | DALL·E 主作者 |
...
| 姓名 | 背景 | 代表 |
|---|---|---|
| Fei-Fei Li | 学术 | 见上（ImageNet、World Labs） |
