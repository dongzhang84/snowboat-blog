...
\medskip\noindent$x$. Set $r:=\dfrac2x$ (the pole on the right of
(3)), so $x=\dfrac2r$.

\medskip\noindent$y$. From the root $t=y+\dfrac1x$ and
$\dfrac1x=\dfrac r2$, we get $y=t-\dfrac r2$.

\medskip\noindent$z$. With no ready-made equation, write $z$ as an
...
\medskip\noindent$b$ from~(3). Solving
$\Phi'(t)=3ct^2-4t+b=\dfrac2x$,
\[
  b = 4t+\frac2x-3ct^2 .
\]

\noindent$2a$ from~(2). Solving $\Phi(t)=ct^3-2t^2+bt-2a=0$,
\[
  2a = ct^3-2t^2+bt .
\]

\noindent$c$ by inverting the $z$-formula. Solving
