...
% Target: 0.6 pp.
Lorentz's theory still lived inside the aether framework. His 1895 theory used local time and length contraction to explain why the Michelson--Morley experiment did not detect aether drift. The experiments that followed were not all designed in direct exchange with Lorentz, but they pressed on the same weak point. Rayleigh, Brace, and Morley--Miller tested consequences of the FitzGerald--Lorentz contraction idea; Trouton--Noble tested whether a charged capacitor moving through the aether should feel a torque. Lorentz did not abandon the aether. He repaired the theory with a more elaborate electron model and additional stabilising assumptions. In this sense, Lorentz was still patching a physical picture.

Poincaré's move was different. In 1905, he treated the impossibility of detecting absolute motion as a general postulate, not as the result of one compensation after another. He gave the Lorentz transformations their group structure, fixed the transformation factor, identified the invariant form, and required the laws of physics, including electrodynamics and gravitation, to respect this symmetry. Mathematically, this brought his theory very close to Einstein's.

The physical picture, however, was not the same. Poincaré still kept the aether as the absolute frame. Quantities measured in moving frames were apparent quantities: local time, contracted length, and synchronized clocks described what moving observers would measure, but the aether frame retained a privileged status.

Einstein removed that privilege. His 1905 paper started from the relativity principle and the constancy of the speed of light, without using the aether as a hidden rest frame. The time $t'$ of a moving inertial frame was not a calculational fiction; it was the time of that frame. Today this is the physical interpretation we usually identify with special relativity. But in 1905 there was no experiment that could separate Lorentz, Poincaré, and Einstein by their observable predictions. The same mathematics could still sit inside different physical pictures.
