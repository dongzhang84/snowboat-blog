...
% Target: 0.6 pp.
Once the electrodynamic side was settled, a natural question followed: how should Newtonian gravity be brought into the new framework? Newton's law acted instantaneously and was not Lorentz covariant. The problem can be posed without any geometry. Spacetime is flat, matter carries a symmetric second-rank energy-momentum tensor $T_{\mu\nu}$ obeying $\partial^\mu T_{\mu\nu} = 0$, and one looks for a Lorentz covariant field on this flat background that couples to matter and reproduces Newtonian gravity in the static weak-field limit.

Poincaré made the first attempt in 1905, modelling the gravitational field on electromagnetism and noting that it implies gravitational waves travelling at $c$. His theory was a vector theory, and as a theory of gravity it was wrong: in a vector field like charges repel, while gravity attracts. The choice was not careless. In 1905 the energy-momentum tensor was not yet available; Minkowski wrote down the stress-energy tensor of the electromagnetic field in 1908, and Laue extended it to general matter systems in 1911. Electrodynamics was the only template Poincaré had, and there the source is a four-current $j^\mu$ and the field a four-potential $A^\mu$, both vectors. Copying that structure gives a vector theory of gravity. He died in 1912, before the tensor formalism reached him.

Nordström took the other obvious route. The Newtonian potential is already a scalar, and Poisson's equation $\nabla^2\varphi = 4\pi G\rho$ applies the Laplacian to it, so the conservative move is to replace the Laplacian with the d'Alembertian, keep the potential a scalar, and take the trace of $T_{\mu\nu}$ as the source. His 1912--1914 theory is self-consistent, Lorentz covariant, attractive, explicitly requires $m_i = m_g$, and gives the correct gravitational redshift. It predicts $-7''$ per century for Mercury and exactly zero deflection of light. The reason it fails could not be seen on paper: the trace of the electromagnetic energy-momentum tensor vanishes identically, so in a scalar theory light is not a source of gravity at all. Whether light bends near the Sun had not been measured by anyone before 1919.

Einstein is usually described as picking the tensor out of these candidates. He did not. From 1907 to 1912 he worked with a scalar theory as well, in which the gravitational potential was a position-dependent speed of light $c(x)$, and the $0.83''$ deflection he published in 1911 came from it. In 1912 he and Nordström were both using scalars. Einstein then found his own theory dynamically inconsistent: it could not handle rotation, and it could not carry the full consequences of the equivalence principle. He returned to Zurich in August 1912 and took Riemannian geometry from Grossmann. Once gravity is the geometry of spacetime, the field has to be the metric: the two indices of $g_{\mu\nu}$ in $ds^2 = g_{\mu\nu}dx^\mu dx^\nu$, and their symmetry, follow from the quadratic form itself. The tensor was not selected. It was handed over by the geometry.

The 1919 eclipse then decided between $0$ and $1.75''$, which fixed the field type. It did not fix the physical picture behind it. A massless spin-2 field on a flat background, coupled to $T_{\mu\nu}$ and to its own energy, sums to the Einstein equations with $g_{\mu\nu} = \eta_{\mu\nu} + h_{\mu\nu}$, a result obtained by Gupta in 1954, Kraichnan in 1955, Feynman in 1962, and Deser in 1970. That reading and curved spacetime remain empirically indistinguishable, and no observation has separated them.
