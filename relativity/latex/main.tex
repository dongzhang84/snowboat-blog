...
More importantly, these proposals often picture history as if all relevant facts had already been collected, and the task were to infer the right theory from a fixed archive. The actual history was not shaped in this way. Maxwell's equations predicted electromagnetic waves and incorporated light into electromagnetism, which in turn motivated the search for the ether wind. The null result of the Michelson--Morley experiment led to Lorentz's contraction hypothesis. The experiments carried out between 1902 and 1904 were no longer testing for the ether wind, but the new predictions generated by the contraction hypothesis itself. The history of relativity was not a one-way move from data to theory; it was a cycle of
\[
