...
Electrodynamics created a different situation. Maxwell's equations unified electricity, magnetism, and light by treating light as an electromagnetic wave. But the equations were not covariant under Galilean transformations, which made the ether look like the natural rest frame for electromagnetic waves. The Michelson--Morley experiment was designed to detect the ether wind, the motion of the Earth through this frame. Its result was null. By the end of the 19th century, relativity was not born from one clean anomaly. It came out of two live situations: a small gravitational residual inside a very successful Newtonian programme, and an electrodynamic theory whose own structure made the ether experimentally suspect.

\subsection{Special Relativity: Lorentz, Poincaré, Einstein}
% Target: 0.6 pp.
Lorentz's route began inside the 19th-century ether programme. His 1895 theory used local time and length contraction to explain why the Michelson--Morley experiment did not detect ether drift. When the Rayleigh, Brace, Trouton--Noble, and Morley--Miller experiments appeared in 1902--1904, he did not abandon the ether. He repaired the theory with a more elaborate electron model and additional stabilising assumptions. In this sense, Lorentz was still patching a physical picture.
