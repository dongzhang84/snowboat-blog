...
回到题目"上辈子"这个隐喻。控制论作为名字死过一次（1980年代被埋葬），作为思想又在另一个肉身里活回来（在AI地基里继续跑）。这一次跟佛教轮回里"灵魂换肉身"不太一样，是它换了肉身、补上算力和数据、长成大十倍的样子。下一次重生可能就是Friston这条线，也可能是别的什么人在别的什么数学外壳里。控制论作为学科的名字大概率不会再回来，但作为思想，它会在AI每一个新阶段里继续回到台前。
