...
软件工程把做软件这件事拆成几个阶段，是有正式标准的。最权威的一份是 ISO/IEC/IEEE 12207《系统与软件工程：软件生命周期过程》，1995 年首发，2017 年更新到现行版，给软件全生命周期定义了几十个标准过程。各国大学的软件工程教材（Pressman 的《Software Engineering: A Practitioner's Approach》、Sommerville 的《Software Engineering》是最经典的两本）讲的也是这套生命周期：需求、设计、开发、测试、上线、运维。互联网公司在这个标准上做了自己的落地，每个环节都映射到具体的工作产物和评审流程。
