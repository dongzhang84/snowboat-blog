...
**Nuwa Skill** · 社区高星。GitHub Trending 过一阵子的 [alchaincyf/nuwa-skill](https://github.com/alchaincyf/nuwa-skill)，号称能"蒸馏"乔布斯、马斯克、张雪峰的认知操作系统，让 Claude 用他们的思维框架分析问题。弃用理由：前三天新鲜，第四天开始怀疑"这真是他会说的话吗"。蒸馏下来的是语言表面，而非思想本体。用来娱乐可以，用来做决策风险极大。
...
`/social-matrix` · 我自己写的。给自媒体朋友推的"一条内容分发到 X / 小红书 / 公众号"。弃用理由：优化一个你根本没有的东西。我连 X 一个平台都没更新稳定，谈什么矩阵。Skill 只能放大你已经在做的动作，救不了你本来就不做的动作。
