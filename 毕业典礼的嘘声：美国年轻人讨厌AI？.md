...
最直接的一件是听众跟AI的关系。CMU工程系毕业生写代码用Copilot提速，做研究用LLM当助手，AI在他们手里就是工具。UCF人文学院毕业生面对的AI是另一种东西，它能写出"够用"的文章、插图、视频脚本，直接挤压他们未来的职业空间。同样一句"AI是下一次工业革命"，在工程学生听来是"我手里的工具又升级了"，在人文学生听来是"我的职业可能消失了"。两边对同一句话的反应自然不一样。
