...
Google用自家的Trillium/TPU v6那条线，从来不外采H100这种规模。Google从2017年开始就有自己的硬件栈，Gemini训练完全跑在自家TPU上。Anthropic 2024年虽然拿过Google投资，但Google给Anthropic的算力是有 ceiling 的，核心TPU产能要先满足Google Search、Gemini、YouTube这些自家业务。
