...
xAI当初按"研究实验室"招的人。这些人习惯长实验周期、试错驱动、论文导向、自由探索。但2026年2月合并SpaceX之后，Musk把他在火箭和工厂那一套以高强度长工时著称的硬件文化整套搬过来：内部把xAI重组成"模块化、产品驱动的组织"，参照Starship和Starlink的里程碑式管理；产品决策不再走xAI内部的研究流程，而是按Musk一贯的SpaceX风格在小圈子里直接拍板；研究周期从"几个月一次评审"压到周级别的迭代。
